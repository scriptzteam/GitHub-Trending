...
* [LearningCircuit / local-deep-research](https://github.com/LearningCircuit/local-deep-research):First to hit ~95% on SimpleQA with a local model (Qwen3.6-27B). Supports any local and cloud LLMs (e.g. llama.cpp, Ollama, Google, Anthropic). Searches 10+ sources - arXiv, PubMed, web, and your private documents. Everything Local & Encrypted.
