...
* [CJackHwang / ds2api](https://github.com/CJackHwang/ds2api):Deepseek客户端对话转API，Go语言，多账号轮询，包含完整后台管理系统，支持纯vercel、docker部署使用。兼容Openclaw🦞，Opencode，Roocode，Claudecode等工具
